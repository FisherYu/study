    ...
    Indicator.prototype = {
        ...
        _drawBarBg: function() {
            var indOption = this.indOption,
                ctx = this.ctx,
                dim = (indOption.radius + indOption.barWidth) * 2, //elm width and height
                startAngle = indOption.startAngle * Math.PI / 180, // to 
                endAngle = indOption.endAngle * Math.PI / 180,
            ...
            if (indOption.barBgColor != "transparent") {
                ctx.beginPath();
                ctx.arc(center, center, indOption.radius - 1 + indOption.barWidth / 2, startAngle, endAngle);
                ctx.stroke();
            }
        },
        ...
        value: function(val) {
            ...
            var ctx = this.ctx,
                ...
                startAngle = indOption.startAngle * Math.PI / 180, // to
                maxArc = Math.abs(indOption.endAngle - indOption.startAngle) / 360 * circ,
                center = dim / 2;
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius - 1 + indOption.barWidth / 2, startAngle, (maxArc * perVal / 100) + startAngle, false);
            ctx.stroke();
